...
impl App {
    ...
    pub fn handle_key_with_mods(
        ...
        // ── Tier 1+4 hidden-pane reachability ──────────────────────────────
        // System / capture panes that live alongside the mockup chrome and
        // are exposed through dedicated App helpers (toggle_monitor_pane etc.)
        // rather than the spawn_chrome module.
